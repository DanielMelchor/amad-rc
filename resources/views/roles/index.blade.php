...
@section('content')
	                ...
	                <div class="card-header">
	                    <div class="row">
							...
							<div class="col-md-2 offset-md-4">
	                            <button type="button" class="btn btn-sm btn-block btn-primary" data-toggle="modal" data-target="#roleModal" title="Crear nuevo permiso"><i class="fas fa-plus">&nbsp;Agregar</i></button>
	                        </div>
							<div class="col-md-2">
								<a href="{{ route('home') }}" class="btn btn-sm btn-block rojo"><i class="fas fa-sign-out-alt">&nbsp;Salir</i></a>
							</div>
	                    </div>
	                </div>
							...
							<div class="col-md-5 offset-md-4">
								<table id="tblroles" class="table table-sm table-bordered table-striped table-hover">
									...
									<tbody>
										...
										<tr>
											<td>{{ $r->name }}</td>
											@php $Id= Crypt::encrypt($r->id); @endphp
											<td><a href="{{ route('editar_role', $Id) }}" class="btn btn-sm btn-warning" title="Editar Role"><i class="fa fa-edit"></i> Editar</a></td>
										</tr>
										@endforeach
									</tbody>
								</table>
	...
	<!-- Modal -->
	<div class="modal fade" id="roleModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="roleModalLabel" aria-hidden="true">
